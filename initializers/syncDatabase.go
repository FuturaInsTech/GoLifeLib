...
func SyncDatabase() {
	...
	DB.AutoMigrate(&models.quotation.QHeader{})
	DB.AutoMigrate(&models.quotation.QDetail{})
	DB.AutoMigrate(&models.quotation.QBenIllValue{})
	...
	DB.AutoMigrate(&models.quotation.Qcommunication{})
